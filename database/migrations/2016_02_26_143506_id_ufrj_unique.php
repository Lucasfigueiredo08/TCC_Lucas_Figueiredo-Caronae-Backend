...
class IdUfrjUnique extends Migration
{
    ...
    public function down()
    {
        Schema::table('users', function ($table) {
            $table->dropUnique('users_id_ufrj_unique'); //users_id_ufrj_unique
        });
    }
    ...
    private function clearUsersWithoutUFRJId()
    {
        ...
        DB::connection()->getPdo()->exec("DELETE 
            ...
            AND u.id_ufrj = '' --u.id_ufrj
        ");

        // Delete the users
        DB::connection()->getPdo()->exec("DELETE FROM users WHERE id_ufrj = ''"); //id_ufrj
    }
