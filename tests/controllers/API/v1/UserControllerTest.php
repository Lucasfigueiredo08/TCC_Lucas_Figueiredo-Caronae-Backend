...
class UserControllerTest extends TestCase
{
    ...
    public function should_create_user()
    {
        ...
        $createdUser = User::where('id_ufrj', $user['id_ufrj'])->first(); //id_ufrj
    ...
    public function should_not_update_protected_fields()
    {
        ...
        $previousInstitutionID = $user->id_ufrj; //id_ufrj
        ...
        $this->assertEquals($previousInstitutionID, $user->id_ufrj); //id_ufrj
